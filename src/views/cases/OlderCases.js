...
class OlderCases extends React.Component {
    ...
    return (
      <div>
        <div className="container-fluid">
          {/* Page Heading */}
          <h1 className="h3 mb-4 text-gray-800">Older Cases </h1>
          <div className="card shadow mb-4">
            <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-primary">List of Older Cases</h6>
            </div>
            <div className="card-body">
              <div className="row">
                <div className="col-md-12 col-lg-3 mb-4" onChange={this.sortCases}>
                  {/* <input type="radio" className="cal-radio d-none" name="patientInfo" id="sortByPatientInfo" defaultValue="patientInfo" defaultChecked />
                  <label className="radio-label" htmlFor="sortByPatientInfo">Patient Info</label> */}
                ...
                <div className="col-md-12 col-lg-3  mb-4" onChange={this.searchByDate}>
                  ...
                  <input type="radio" className="cal-radio d-none" name="dateFilter" id="searchWeek" defaultValue="week" />
                  <label className="radio-label radius-right" htmlFor="searchWeek">1 week</label>
                </div>
...
export default connect(mapStateToProps)(OlderCases);
